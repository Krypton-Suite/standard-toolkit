...
namespace Krypton.Toolkit
{
    ...
    /// </summary>
    public class PaletteOffice2007SilverLightMode : PaletteOffice2007Base
    {
        ...
        private static readonly Image _silverCloseNormal =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonCloseHover;

        private static readonly Image _silverCloseDisabled =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonCloseDisabled;

        private static readonly Image _silverMaximiseNormal =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonMaxHover;

        private static readonly Image _silverMaximiseDisabled =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonMaxDisabled;

        private static readonly Image _silverMinimiseNormal =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonMinHover;

        private static readonly Image _silverMinimiseDisabled =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonMinDisabled;

        private static readonly Image _silverRestoreNormal =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonRestoreHover;

        private static readonly Image _silverRestoreDisabled =
            Resources.Office2007ControlBoxResources.Office2007SilverControlBoxButtonRestoreDisabled;
        ...
        private static readonly Color[] _schemeColors = { Color.FromArgb(56,  63,  70),    // TextLabelControl
                                                                      ...
                                                                      Color.FromArgb(241, 242, 244),    // InputControlBackNormal
                                                 ...
                                                 PaletteState state)
        {
            switch (style)
            {
                case PaletteButtonSpecStyle.FormClose:
                    return state == PaletteState.Disabled ? _silverCloseDisabled : _silverCloseNormal;

                case PaletteButtonSpecStyle.FormMin:
                    return state == PaletteState.Disabled ? _silverMinimiseDisabled : _silverMinimiseNormal;

                case PaletteButtonSpecStyle.FormMax:
                    return state == PaletteState.Disabled ? _silverMaximiseDisabled : _silverMaximiseNormal;

                case PaletteButtonSpecStyle.FormRestore:
                    return state == PaletteState.Disabled ? _silverRestoreDisabled : _silverRestoreNormal;
